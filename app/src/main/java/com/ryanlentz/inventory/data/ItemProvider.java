...
public class ItemProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.ryanlentz.items/items/3",
        ...
        // for. If the data for this URI changes, then we know we need to update the Cursor.
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        // No need to check the description since it is not required.
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ItemEntry#COLUMN_ITEMQUANTITY} key is present,
